...
const releaseMeta={version:'v1.43',cutoff:'2026/09/06 23:00',timezone:'Asia/Taipei',reviewed:'2026/09/06'};
...
camellia.push(
 ...
 released('PROD-C-017','麻油車／統購實業','冷壓黑麻油 255mL','2028/05/03','red','列入下架回收／本批檢驗數值未公開','食藥署列入回收範圍；請停止食用並向原通路退貨。本效期沒有個別公開檢驗數值。','sesame'),
...
for(const row of timeline){
 if(row[3].includes('麻油車冷壓黑麻油檢出'))row[4]='效期2028/04/06檢出3.2 μg/kg；另2028/05/03、2028/06/24列入回收，未公布各自檢驗值。三效期共360瓶出貨聖德科斯，請停止食用並退貨。';
